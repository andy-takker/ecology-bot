...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_global_mailing_description"),
        "global_mailing",
        ["description"],
        unique=False,
    )
    op.create_index(
        op.f("ix_global_mailing_global_event_id"),
        "global_mailing",
        ["global_event_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_global_mailing_id"), "global_mailing", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_global_mailing_name"), "global_mailing", ["name"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_global_mailing_global_event_id"), table_name="global_mailing"
    )

...
async def show_organization_by_activity(
    ...
    if organizations:
        ...
        msg.append(
            "В Вашем районе не зарегистрированы экологические организации с таким направлением."
        )
        msg.append(
            "Возможно, они появятся позже, а пока можете выбрать другой район или направление"
        )

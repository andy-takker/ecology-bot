...
async def on_activity_selected(c: CallbackQuery, widget: Any, manager: DialogManager, item_id: str):
...
class ActivityWindow(Window):
    ...
    def __init__(self, state: State, prev: Type[Back | Cancel] = Cancel, all=True, prev_state: None | State = None):

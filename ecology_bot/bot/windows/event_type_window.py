...
EVENT_TYPES: dict[int, EventTypeData] = {
    ...
    2: EventTypeData(name='Нужны волонтеры на мероприятие', type=EventType.RECRUITMENT, id='2'),
}
...
class EventTypeWindow(Window):
    def __init__(self, state: State, event_type_states: dict[EventType, State]):
        ...
        async def on_event_type_selected(c: CallbackQuery, widget: Any, manager: DialogManager, item_id: str):
